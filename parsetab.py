...
_lr_productions = [
  ...
  ('list -> LCOR valores RCOR','list',3,'p_list','analizador_semantico.py',98),
  ('valores -> valor','valores',1,'p_valores','analizador_semantico.py',103),
  ('valores -> valor COMMA valores','valores',3,'p_valores','analizador_semantico.py',104),
  ('condicion -> valor comparador valor','condicion',3,'p_condicion','analizador_semantico.py',112),
  ('condicion -> condicion conector condicion','condicion',3,'p_condicion','analizador_semantico.py',113),
  ('valor -> VARIABLE','valor',1,'p_valor','analizador_semantico.py',128),
  ('valor -> INTEGER','valor',1,'p_valor','analizador_semantico.py',129),
  ('valor -> FLOAT','valor',1,'p_valor','analizador_semantico.py',130),
  ('valor -> expresion','valor',1,'p_valor','analizador_semantico.py',131),
  ('operador -> PLUS','operador',1,'p_operador','analizador_semantico.py',140),
  ('operador -> MINUS','operador',1,'p_operador','analizador_semantico.py',141),
  ('operador -> TIMES','operador',1,'p_operador','analizador_semantico.py',142),
  ('operador -> DIVIDE','operador',1,'p_operador','analizador_semantico.py',143),
  ('comparador -> LESS_THAN','comparador',1,'p_comparador','analizador_semantico.py',146),
  ('comparador -> GREATER_THAN','comparador',1,'p_comparador','analizador_semantico.py',147),
  ('comparador -> EQUALS','comparador',1,'p_comparador','analizador_semantico.py',148),
  ('comparador -> NOT_EQUALS','comparador',1,'p_comparador','analizador_semantico.py',149),
  ('comparador -> LESS_EQUAL_THAN','comparador',1,'p_comparador','analizador_semantico.py',150),
  ('comparador -> GREATER_EQUAL_THAN','comparador',1,'p_comparador','analizador_semantico.py',151),
  ('conector -> AND','conector',1,'p_conector','analizador_semantico.py',155),
  ('conector -> OR','conector',1,'p_conector','analizador_semantico.py',156),
  ('solicitud -> INPUT LPAREN COMILLA STRING COMILLA RPAREN','solicitud',6,'p_solicitud','analizador_semantico.py',159),
  ('sentenciaCase -> CASE valor WHEN condicion programa WHEN condicion programa ELSE programa END','sentenciaCase',11,'p_sentenciaCase','analizador_semantico.py',162),
  ('sentenciaIf -> IF condicion programa ELSE programa END','sentenciaIf',6,'p_sentenciaIf','analizador_semantico.py',165),
  ('declaracion -> VARIABLE EQUAL valor','declaracion',3,'p_declaracion','analizador_semantico.py',172),
  ('declaracion -> VARIABLE EQUAL LIST','declaracion',3,'p_declaracion','analizador_semantico.py',173),
  ('sentenciaWhile -> WHILE condicion programa END','sentenciaWhile',4,'p_sentenciaWhile','analizador_semantico.py',189),
  ('length_list -> valor POINT LENGTH','length_list',3,'p_length_list','analizador_semantico.py',205),
  ('asignacion_booleana -> VARIABLE EQUAL BOOLEAN','asignacion_booleana',3,'p_asignacion_booleana','analizador_semantico.py',218),
]
