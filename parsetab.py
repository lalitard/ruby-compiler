...
_lr_productions = [
  ...
  ('programa -> expresion','programa',1,'p_programa','analizador_semantico_gui.py',26),
  ('programa -> imprimir','programa',1,'p_programa','analizador_semantico_gui.py',27),
  ('programa -> imprimir_vacio','programa',1,'p_programa','analizador_semantico_gui.py',28),
  ('programa -> sentenciaIf','programa',1,'p_programa','analizador_semantico_gui.py',29),
  ('programa -> solicitud','programa',1,'p_programa','analizador_semantico_gui.py',30),
  ('programa -> sentenciaCase','programa',1,'p_programa','analizador_semantico_gui.py',31),
  ('programa -> sentenciaWhile','programa',1,'p_programa','analizador_semantico_gui.py',32),
  ('programa -> list','programa',1,'p_programa','analizador_semantico_gui.py',33),
  ('programa -> length_list','programa',1,'p_programa','analizador_semantico_gui.py',34),
  ('programa -> declaracion','programa',1,'p_programa','analizador_semantico_gui.py',35),
  ('expresion -> valor operador valor','expresion',3,'p_expresion','analizador_semantico_gui.py',40),
  ('expresion -> expresion_binaria','expresion',1,'p_expresion','analizador_semantico_gui.py',41),
  ('expresion -> expresion_par','expresion',1,'p_expresion','analizador_semantico_gui.py',42),
  ('expresion -> expresion_mul_div','expresion',1,'p_expresion','analizador_semantico_gui.py',43),
  ('expresion -> expresion_add_sub','expresion',1,'p_expresion','analizador_semantico_gui.py',44),
  ('expresion_binaria -> expresion operador valor','expresion_binaria',3,'p_expresion_binaria','analizador_semantico_gui.py',70),
  ('expresion_par -> LPAREN expresion RPAREN','expresion_par',3,'p_expresion_par','analizador_semantico_gui.py',73),
  ('expresion_mul_div -> expresion TIMES valor','expresion_mul_div',3,'p_expresion_mul_div','analizador_semantico_gui.py',77),
  ('expresion_mul_div -> expresion DIVIDE valor','expresion_mul_div',3,'p_expresion_mul_div','analizador_semantico_gui.py',78),
  ('expresion_add_sub -> expresion PLUS valor','expresion_add_sub',3,'p_expresion_add_sub','analizador_semantico_gui.py',83),
  ('expresion_add_sub -> expresion MINUS valor','expresion_add_sub',3,'p_expresion_add_sub','analizador_semantico_gui.py',84),
  ('imprimir -> PRINT LPAREN valores RPAREN','imprimir',4,'p_imprimir','analizador_semantico_gui.py',89),
  ('imprimir_vacio -> PRINT LPAREN RPAREN','imprimir_vacio',3,'p_imprimir_vacio','analizador_semantico_gui.py',93),
  ('list -> LCOR valores RCOR','list',3,'p_list','analizador_semantico_gui.py',97),
  ('valores -> valor','valores',1,'p_valores','analizador_semantico_gui.py',102),
  ('valores -> valor COMMA valores','valores',3,'p_valores','analizador_semantico_gui.py',103),
  ('condicion -> valor comparador valor','condicion',3,'p_condicion','analizador_semantico_gui.py',111),
  ('condicion -> condicion conector condicion','condicion',3,'p_condicion','analizador_semantico_gui.py',112),
  ('valor -> VARIABLE','valor',1,'p_valor','analizador_semantico_gui.py',127),
  ('valor -> INTEGER','valor',1,'p_valor','analizador_semantico_gui.py',128),
  ('valor -> FLOAT','valor',1,'p_valor','analizador_semantico_gui.py',129),
  ('valor -> expresion','valor',1,'p_valor','analizador_semantico_gui.py',130),
  ('operador -> PLUS','operador',1,'p_operador','analizador_semantico_gui.py',139),
  ('operador -> MINUS','operador',1,'p_operador','analizador_semantico_gui.py',140),
  ('operador -> TIMES','operador',1,'p_operador','analizador_semantico_gui.py',141),
  ('operador -> DIVIDE','operador',1,'p_operador','analizador_semantico_gui.py',142),
  ('comparador -> LESS_THAN','comparador',1,'p_comparador','analizador_semantico_gui.py',145),
  ('comparador -> GREATER_THAN','comparador',1,'p_comparador','analizador_semantico_gui.py',146),
  ('comparador -> EQUALS','comparador',1,'p_comparador','analizador_semantico_gui.py',147),
  ('comparador -> NOT_EQUALS','comparador',1,'p_comparador','analizador_semantico_gui.py',148),
  ('comparador -> LESS_EQUAL_THAN','comparador',1,'p_comparador','analizador_semantico_gui.py',149),
  ('comparador -> GREATER_EQUAL_THAN','comparador',1,'p_comparador','analizador_semantico_gui.py',150),
  ('conector -> AND','conector',1,'p_conector','analizador_semantico_gui.py',154),
  ('conector -> OR','conector',1,'p_conector','analizador_semantico_gui.py',155),
  ('solicitud -> INPUT LPAREN COMILLA STRING COMILLA RPAREN','solicitud',6,'p_solicitud','analizador_semantico_gui.py',158),
  ('sentenciaCase -> CASE valor WHEN condicion programa WHEN condicion programa ELSE programa END','sentenciaCase',11,'p_sentenciaCase','analizador_semantico_gui.py',161),
  ('sentenciaIf -> IF condicion programa ELSE programa END','sentenciaIf',6,'p_sentenciaIf','analizador_semantico_gui.py',164),
  ('declaracion -> VARIABLE EQUAL valor','declaracion',3,'p_declaracion','analizador_semantico_gui.py',171),
  ('declaracion -> VARIABLE EQUAL LIST','declaracion',3,'p_declaracion','analizador_semantico_gui.py',172),
  ('sentenciaWhile -> WHILE condicion programa END','sentenciaWhile',4,'p_sentenciaWhile','analizador_semantico_gui.py',188),
  ('length_list -> valor POINT LENGTH','length_list',3,'p_length_list','analizador_semantico_gui.py',204),
  ('asignacion_booleana -> VARIABLE EQUAL BOOLEAN','asignacion_booleana',3,'p_asignacion_booleana','analizador_semantico_gui.py',217),
]
